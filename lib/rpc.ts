...
export class Client {
  ...
  constructor(core: WorkerCore, options: any = {}) {
    this.core = core;
    this.log = Function.prototype.bind.call(console.log, console, `[Hoosat gRPCProxy]:`);
...
export class RPC implements IRPC {
  ...
  subscribeChainChanged(callback: Rpc.callback<Rpc.ChainChangedNotification>) {
    return this.subscribe<Rpc.NotifyChainChangedResponse, Rpc.ChainChangedNotification>(
      "notifyChainChangedRequest",
      {},
      callback
    );
  }
  subscribeBlockAdded(callback: Rpc.callback<Rpc.BlockAddedNotification>) {
    return this.subscribe<Rpc.NotifyBlockAddedResponse, Rpc.BlockAddedNotification>(
  ...
  subscribeVirtualSelectedParentBlueScoreChanged(
    ...
    return this.subscribe<
      Rpc.NotifyVirtualSelectedParentBlueScoreChangedResponse,
      Rpc.VirtualSelectedParentBlueScoreChangedNotification
  ...
  subscribeUtxosChanged(addresses: string[], callback: Rpc.callback<Rpc.UtxosChangedNotification>) {
    return this.subscribe<Rpc.NotifyUtxosChangedResponse, Rpc.UtxosChangedNotification>(
  ...
  subscribeVirtualDaaScoreChanged(callback: Rpc.callback<Rpc.VirtualDaaScoreChangedNotification>) {
    return this.subscribe<Rpc.NotifyVirtualDaaScoreChangedResponse, Rpc.VirtualDaaScoreChangedNotification>(
